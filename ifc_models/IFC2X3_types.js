...
value: _param || 0
    ...
    exports.IFCDAYINMONTHNUMBER = IFCDAYINMONTHNUMBER;
     ...
     class IFCDAYLIGHTSAVINGHOUR extends IFC {
        constructor(_param) {
                super();
                this.add_attr({
value: _param || 0
    ...
    exports.IFCDAYLIGHTSAVINGHOUR = IFCDAYLIGHTSAVINGHOUR;
...
value: _param || 0
    ...
    exports.IFCHEATINGVALUEMEASURE = IFCHEATINGVALUEMEASURE;
     ...
     class IFCHOURINDAY extends IFC {
        constructor(_param) {
                super();
                this.add_attr({
value: _param || 0
    ...
    exports.IFCHOURINDAY = IFCHOURINDAY;
...
value: _param || 0
    ...
    exports.IFCMASSPERLENGTHMEASURE = IFCMASSPERLENGTHMEASURE;
     ...
     class IFCMINUTEINHOUR extends IFC {
        constructor(_param) {
                super();
                this.add_attr({
value: _param || 0
    ...
    exports.IFCMINUTEINHOUR = IFCMINUTEINHOUR;
...
value: _param || 0
    ...
    exports.IFCROTATIONALSTIFFNESSMEASURE = IFCROTATIONALSTIFFNESSMEASURE;
     ...
     class IFCSECONDINMINUTE extends IFC {
        constructor(_param) {
                super();
                this.add_attr({
value: _param || 0
    ...
    exports.IFCSECONDINMINUTE = IFCSECONDINMINUTE;
...
value: _param || 0
    ...
    exports.IFCWARPINGMOMENTMEASURE = IFCWARPINGMOMENTMEASURE;
     ...
     class IFCYEARNUMBER extends IFC {
        constructor(_param) {
                super();
                this.add_attr({
value: _param || 0
    ...
    exports.IFCYEARNUMBER = IFCYEARNUMBER;
